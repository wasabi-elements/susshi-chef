...
(function($) {
  $.fn.colorPicker = function($$options) {
    // Defaults
    var $defaults = {
      color:["", "#e63a7a", "#f6401a", "#f88d82", "#f9b43f", "#fad877",
    "#fcf995", "#b0dd8c", "#77bb41", "#4f7a28", "#53d5fd",
    "#74a7fe", "#37a3d7", "#874efd", "#929292", "#c0c0c0",
    "#ebebeb", "#ffffff"],
      defaultColor: "#ffffff",
      columns: 0,
    ...
    return this.each(function() {
      ...
      for(var i=0;i<o.color.length;i++){
        if (o.color[i] == "")
            _html += '<div class="transparent""></div>';
        else
            _html += '<div style="background-color:'+o.color[i]+';"></div>';
        if($$oldIndex==-1 && o.defaultColor==o.color[i]) $$oldIndex = i;
      }
      
      $this.html('<div class="jColorSelectLabel">Color</div><div class="jColorSelect">'+_html+'</div>');
