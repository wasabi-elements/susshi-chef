...
class ProfileSerializer < ActiveModel::Serializer
  ...
  attributes :id, :name, :description, :client_auth_set_id, :LoggingMask, :MaxSessionIdleSeconds, :MaxSessionSeconds,
             ...
             :SSHX11Forward, :TargetHostKeyLearning, :TargetPreferredAuthentications
