...
class TargetDomainHost < Target
  ...
  has_one :swift_domain_host, foreign_key: 'target_id', dependent: :destroy
  ...
  validates :hostname, uniqueness: { case_sensitive: false, scope: :partition_id, message: 'same name already exists within partition' }
