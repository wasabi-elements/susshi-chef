...
This repository contains the open-source core of **suSSHi Chef** — the administration UI, REST API and policy decision point of the suSSHi Suite.
...
**Source code**: https://github.com/wasabi-elements/susshi-chef
