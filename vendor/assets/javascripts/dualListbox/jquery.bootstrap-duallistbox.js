;(function ($, window, document, undefined) {
  ...
  function bindEvents(dualListbox) {
    ...
    dualListbox.elements.filterInput1.on('change keyup', function() {
      filter(dualListbox, 1);
      // Wasabi Patched (https://github.com/istvan-ujjmeszaros/bootstrap-duallistbox/issues/110#issuecomment-387394073)
      // Wasabi Patched - use 'this' instead of '$(this)' due to an issue with Firefox (looses focus)
      this.blur();
      this.focus();
    });
